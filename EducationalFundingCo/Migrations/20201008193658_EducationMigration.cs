        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncomePercentage = table.Column<int>(nullable: false),
                    Duration = table.Column<string>(nullable: true),
                    Cap = table.Column<decimal>(nullable: false),
                    MinIncome = table.Column<decimal>(nullable: false),
                    Approval = table.Column<string>(nullable: true),
                    MaxDefermentPeriod = table.Column<string>(nullable: true),
                    StartCollecting = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocialSecurityNum = table.Column<string>(nullable: true),
                    AcceptedDate = table.Column<DateTimeOffset>(nullable: true),
                    CompletedDate = table.Column<DateTimeOffset>(nullable: true),
                    EstCompletedDate = table.Column<DateTimeOffset>(nullable: true),
                    PaymentFenquency = table.Column<string>(nullable: true),
                    MaxDelinquencyAge = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contracts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Contracts_AcademyPrograms_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Meduim = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Communications_Contracts_ContractId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(nullable: true),
                    ScheduledDate = table.Column<DateTimeOffset>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_AcademyPrograms_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "AcademyPrograms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Communications_ContractId",
                table: "Communications",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_Contracts_ProgramId",
                table: "Contracts",
                column: "ProgramId");
