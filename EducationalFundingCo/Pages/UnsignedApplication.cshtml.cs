...
namespace EducationalFundingCo.Pages
{
    ...
    public class UnsignedApplicationModel : PageModel
    {
        private readonly EducationalFundingCoContext _context;
        private readonly UserManager<IdentityUser> _userManager;
        public UnsignedApplicationModel(EducationalFundingCoContext context, UserManager<IdentityUser> userManager)
        {
            _context = context;
