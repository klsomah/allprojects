...
namespace EducationalFundingCo.Pages
{
    ...
    public class ContractsModel : PageModel
    {
        ...
        public ContractsModel(EducationalFundingCoContext context, UserManager<IdentityUser> userManager)
        {
            _context = context;
            _userManager = userManager; 
        }
        [BindProperty]
        public Areas.Identity.Data.Contract Contract
        {
            get; set;
        }
        ...
        public async Task OnGetAsync()
        {
            try
            {
                ...
                {
                    Contracts = await Task.Run(() => _context.Contracts.Include(c => c.AcademyProgram).Include(c => c.School).Where(x => x.School.RecordStatus==2).ToListAsync());
        ...
        //public async Task<IActionResult> OnGetDeleteRecordAsync(int? id)
        //{
        //    if (id == null)
        //    {
        //        return NotFound();
